...
export default function PolePanel({
                                      ...
                                      scanProgress, scanTotal, onRenamePole,
                                  }: Props) {
        ...
        <div className="w-72 border-r border-border bg-surface flex flex-col h-full">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    {isEditing ? (
                                        ...
                                        <p className={`font-mono text-xs font-semibold truncate ${isReview ? "text-[#92400e]" : ""}`}>
                                ...
                                <div className="flex items-center gap-1 flex-shrink-0">
                                    ...
                                    <span className={`text-[9px] px-1.5 py-0.5 rounded font-semibold
                                        ...
                                        {tag.source === "text" ? "TXT" : tag.source === "mtext" ? "MTXT" : "STR"}
                                    </span>
                                    <span
                                        role="button"
                                        tabIndex={0}
                                ...
                                <div className="px-3 pb-3 flex flex-col gap-2">
                                    ...
                                    {tag.crop_b64 ? (
                                        ...
                                        <div className="rounded-lg border border-border bg-surface-2 flex items-center justify-center h-16">
                                            <p className="text-[10px] text-muted italic">
                                                {tag.source === "stroke" ? "No crop available" : tag.name}
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    {tag.ocr_conf !== null && tag.ocr_conf !== undefined && (
                                        <div className="flex items-center gap-2">
                                            {(() => {
                                                ...
                                                return b ? (
                                                    <span className={`text-[9px] px-1.5 py-0.5 rounded font-semibold ${b.cls}`}>
                                                        {b.label} confidence
                                                    </span>
                                                ) : null;
                                            })()}
                                            {tag.needs_review && (
                                                <span className="text-[9px] text-[#b91c1c] font-semibold">⚠ Needs review</span>
                                            )}
                                        </div>
                                    )}
                                    ...
                                    <div className="flex gap-1.5">
                                        ...
                                        <button
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                const input = document.getElementById(`inline-rename-${tag.pole_id}`) as HTMLInputElement;
            ...
            {tags.length > 0 && (
                <div className="px-3 py-2 border-t border-border text-[10px] text-muted flex-shrink-0 flex justify-between">
                    ...
                    {search && (
                        <button onClick={() => setSearch("")} className="text-[#f59e0b] hover:underline">Clear</button>
                    )}
                </div>
            )}
        </div>
